...
export const generateHarmony = (
  ...
  switch (rule) {
    ...
    case HarmonyRule.SOLAR_FLARE: steps = [{ hOffset: 0, sOffset: 20, lOffset: 10 }, { hOffset: angle, sOffset: 15, lOffset: 5 }, { hOffset: angle * 2, sOffset: 10, lOffset: 0 }]; break;
    case HarmonyRule.OCEANIC: steps = [{ hOffset: 180, sOffset: 10, lOffset: -10 }, { hOffset: 180 + angle, sOffset: 5, lOffset: -5 }, { hOffset: 180 + angle * 2, sOffset: 0, lOffset: 0 }]; break;
    case HarmonyRule.FOREST_EDGE: steps = [{ hOffset: 90, sOffset: -10, lOffset: -15 }, { hOffset: 90 + angle, sOffset: -5, lOffset: -10 }, { hOffset: 90 + angle * 2, sOffset: 0, lOffset: -5 }]; break;
    case HarmonyRule.CYBERPUNK: steps = [{ hOffset: 0, sOffset: 30, lOffset: 5 }, { hOffset: 180 - angle, sOffset: 20, lOffset: 0 }, { hOffset: 180 + angle, sOffset: 25, lOffset: 10 }]; break;
    case HarmonyRule.ROYAL: steps = [{ hOffset: 0, sOffset: 10, lOffset: -10 }, { hOffset: 270, sOffset: 15, lOffset: -5 }, { hOffset: angle * 1.5, sOffset: 20, lOffset: 10 }]; break;
    case HarmonyRule.EARTHY: steps = [{ hOffset: angle * 0.5, sOffset: -10, lOffset: -20 }, { hOffset: angle, sOffset: -15, lOffset: -15 }, { hOffset: angle * 1.5, sOffset: -10, lOffset: -10 }]; break;
